 ...
 * Runs after `20260816` adds T2 variant columns so `payload.create` matches the physical table.
...
export async function down(_args: MigrateDownArgs): Promise<void> {
  throw new Error(
    'Migration 20260818_120000_seed_seo_theory_pipeline_profiles is irreversible; delete rows in Admin if needed.',
  )
}
